...
const Will = ({ newDay }) => {
  ...
  const getSum = () => {
    let sumOfFinalDay = 0.0;
    const dayofWeek = getDayofWeek(6, "num");
    const date = getDayofWeek(6, "date");
    ...
    data.map((habit) => {
      ...
      } else if (days[dayofWeek] && date >= createdAt) {
        sumOfFinalDay -= valuePerDay;
      }
    });
  ...
  return (
    <div className="container-fluid">
          ...
          <tfoot>
            <tr className="d-none d-md-table-row">
              ...
              <td className="text-center align-middle">
                <div
                  className="m-auto d-flex align-items-center justify-content-center position-relative"
                ...
                >
                  ...
                  <div
                    className={
                      styles.innerText +
                      " text-dark d-flex align-items-center justify-content-center"
                    }
                  >
      ...
      <div className="text-center mt-3">
        <Link href="/new-habit">
          <button className="btn btn-danger gradientButton text-dark">
